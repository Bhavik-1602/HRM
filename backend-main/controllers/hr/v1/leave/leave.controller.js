...
// Hr edit or cancel leave request
const editLeaveRequest = async (req, res) => {
  try {
    ...
    const leave = await LeaveModel.findOne({ _id: leaveId, hr_id });
...
const getHrLeaveBalance = async (req, res) => {
  try {
...
// Get Hr's Leave Records with Pagination
